...
const advantageCards = [
  {
    ...
    desc: 'Real-time decisioning allows Kashle to move at product speed instead of branch speed.'
  },
  {
          ...
          <div className="about-hero__grid">
            <div>
              ...
              <p className="about-subtitle">
                Kashle combines trust, speed, and transparent economics into a calmer lending experience for real-life emergencies. Instead of making users decode finance, we design clarity into the interface itself.
              </p>
            ...
            <div className="about-hero__visual">
              ...
              <div className="about-hero__panel glass-panel">
                <div className="about-hero__panel-top">
                  <span>Kashle confidence layer</span>
                  <strong>10L+</strong>
                </div>
        ...
        <div className="container about-story__grid">
          <div className="about-story__sticky">
            <div className="about-story__copy">
              ...
              <p>
                Traditional short-term lending often feels fragmented, uncertain, and overly procedural. Kashle is built around one idea: urgent borrowing should feel guided, premium, and understandable from the first tap to repayment.
              </p>
              <p>
      ...
      <section className="about-advantage">
        <div className="container">
          <div className="about-advantage__header">
            <h2 className="section-title">The Kashle Technology Advantage</h2>
