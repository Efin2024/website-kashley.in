...
const legalContentMap = {
  terms: {
    ...
    sections: [
      { h: '1. Acceptance of Terms', p: "By accessing or using Kashle's services, you agree to be bound by these Terms and Conditions. If you do not agree to all terms, you may not access the website or use the services." },
            ...
            <main className="legal-main">
              <div className="legal-document">
                <p className="legal-intro">
                  This document outlines the official {content.title.toLowerCase()} for Kashle as presented through our digital product and compliance communication layer. Please review it carefully before proceeding with related actions.
                </p>
                ...
                <div className="legal-footer">
                  ...
                  <p>Contact our grievance officer at grievance@kashle.com or call 9999999999.</p>
                </div>
              </div>
            </main>
          </div>
