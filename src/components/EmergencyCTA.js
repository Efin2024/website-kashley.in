        ...
        <div className="emergency-cta__card">
          ...
          <div className="emergency-cta__content">
            ...
            <p className="emergency-cta__desc">
              Whether it is a medical bill, urgent repair, or unexpected expense, QUA is built to calm the chaos. Apply now and get up to ₹1,00,000 sent directly to your bank account within minutes.
            </p>
