      ...
      <div className="container hero__container">
        <div className="hero__content">
          ...
          <p className="hero__subtitle">
            Kashle blends the speed of a checkout flow with the calm of a premium product experience. Get up to <span className="highlight-amount">₹1 Lakh</span>, transparent <strong>1% per day pricing</strong>, and a fully digital journey built for real emergencies.
          </p>
        ...
        <div className="hero__visual">
          ...
          <div className="hero__image-wrapper">
            <div className="hero__eyebrow">Kashle Fast Lane</div>
